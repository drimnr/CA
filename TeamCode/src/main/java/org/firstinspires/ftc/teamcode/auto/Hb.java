...
public class Hb extends OpMode {
    ...
    private  Pose pick1pose = new Pose(26.6, 20, Math.toRadians(0));
    private  Pose pick2pose = new Pose(26.6, 30, Math.toRadians(0));
    private  Pose pick3pose = new Pose(20, 29.5, Math.toRadians(30));
    ...
    public void buildPaths() {
        ...
        pick1 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(scorePose), new Point(pick1pose.getX()-5, pick1pose.getY())))
        ...
        pick2 = follower.pathBuilder()
                .addPath(new BezierLine(new Point(scorePose), new Point(pick2pose.getX()-5, pick2pose.getY())))
